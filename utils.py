...
class TrainDatasetFromFolder(Dataset):
    def __init__(self, dataset_dir, crop_size, upscale_factor):
        ...
        self.image_filenames = [join(dataset_dir, x) for x in listdir(dataset_dir) if isImageFile(x)]
...
class TestDatasetFromFolder(Dataset):
    def __init__(self, dataset_dir, upscale_factor):
        ...
        self.upscale_factor = upscale_factor
        self.lr_filenames = [join(self.lr_path, x) for x in listdir(self.lr_path) if isImageFile(x)]
        self.hr_filenames = [join(self.hr_path, x) for x in listdir(self.hr_path) if isImageFile(x)]
